...
# Plot Maps ----------------------------------------
storm_data <- read_csv("~/Desktop/Geographic Distributions of Extreme Weather Risk Perceptions/Data/Storm Data/Storm_Data_by_CWA.csv")
...
cwa.shp <- ms_simplify(cwa.shp, keep = 0.01, keep_shapes = TRUE)
...
# Howe Validation ----------------------------------------
howe_data <- read_csv("~/Desktop/Geographic Distributions of Extreme Weather Risk Perceptions/Data/Howe Data/Howe_Data_by_CWA.csv")
