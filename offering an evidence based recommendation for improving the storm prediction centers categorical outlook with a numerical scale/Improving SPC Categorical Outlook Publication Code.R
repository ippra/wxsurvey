...
#SPCdata<-read.csv("Read in CSV here")
...
ggplot(Scale_con_means, aes(x = Level, y = mean, color = Version, Level = Version, shape = Version)) +
  ...
  theme(plot.margin = unit(c(2, 2, 15, 2), "mm"), legend.key.spacing.y = unit(0.5, 'cm'))  
...
a <- Postdata %>%
  ...
  scale_x_discrete(limits= c("Not at all","Not very much","Somewhat","Very much","Extensively"),
                   labels= c("Not at\nall","Not very\nmuch","Somewhat","Very\nmuch","Extensively")) + 
  #scale_y_continuous(limits = c(0,0.7)) +
  scale_fill_manual(values = Diverge, limits = factor(c("Not at all","Not very much","Somewhat","Very much","Extensively"))) +
  labs(title = "Would changing the SPC scale\nimpact your operations?",x = "", y = "Proportion of Responses") +
...
#ggsave(filename = "Impact and Importance.png", height = 10, width = 10, path = "Directory of Choice", g)
...
Scale_con_means <- SPCdata %>% 
  ...
  summarise(mean = mean(value, na.rm = TRUE), 
            ...
            n = n()) %>% 
  mutate(se = sd / sqrt(n))
a = ggplot(Scale_con_means, aes(x = Level, y = mean, color = Version, Level = Version, shape = Version)) +
  geom_line(linewidth = 1.2, position = position_dodge(width = 0.35)) +
  geom_point(size = 3.5, position = position_dodge(width = 0.35)) +
  geom_errorbar(size = 1.2, aes(ymin = mean - (1.645 * se), ymax = mean + (1.645 * se)), width = 0.3, position = position_dodge(width = 0.35)) +
  scale_shape_manual(name = "Scale", values = c(15, 16, 17, 18), limits = c("current_scale","likert_scale","spanish_scale","levels_scale"), 
  ...
  scale_color_manual(limits = c("current_scale","likert_scale","spanish_scale","levels_scale"), 
                     labels=c('Current\nScale', 'Likert\nScale', '"Spanish"\nScale', 'Numbered\nScale'), values = colors) +
  labs(y = "Mean Concern", x = "", color = "Scale", title = "a.) Unweighted Concern by Scale Only") +
  annotate("text", x = 1:5, y = 13, label = c("MARGINAL", "SLIGHT", "ENHANCED", "MODERATE", "HIGH"), size = 5, color = colors[1]) +
  annotate("text", x = 1:5, y = 10, label = c("VERY LOW", "LOW", "MEDIUM", "HIGH", "VERY HIGH"), size = 5, color = colors[2]) +
  annotate("text", x = 1:5, y = 7, label = c("MINIMAL", "LOW", "MODERATE", "HIGH", "EXTREME"), size = 5, color = colors[3]) +
  annotate("text", x = 1:5, y = 4, label = c("LEVEL 1 OF 5", "LEVEL 2 OF 5", "LEVEL 3 OF 5", "LEVEL 4 OF 5", "LEVEL 5 OF 5"), size = 5, color = colors[4]) +
...
Scale_resp_means <- SPCdata %>% 
  ...
  summarise(mean = mean(value, na.rm = TRUE), 
            ...
            n = n()) %>% 
  mutate(se = sd / sqrt(n))
b = ggplot(Scale_resp_means, aes(x = Level, y = mean, color = Version, Level = Version, shape = Version)) +
  geom_line(linewidth = 1.2, position = position_dodge(width = 0.35)) +
  geom_point(size = 3.5, position = position_dodge(width = 0.35)) +
  geom_errorbar(size = 1.2, aes(ymin = mean - (1.645 * se), ymax = mean + (1.645 * se)), width = 0.3, position = position_dodge(width = 0.35)) +
  scale_shape_manual(name = "Scale", values = c(15, 16, 17, 18), limits = c("current_scale","likert_scale","spanish_scale","levels_scale"), 
  ...
  scale_color_manual(limits = c("current_scale","likert_scale","spanish_scale","levels_scale"), 
                     labels=c('Current\nScale', 'Likert\nScale', '"Spanish"\nScale', 'Numbered\nScale'), values = colors) +
  labs(y = "Mean Likeihood of Response", x = "", color = "Scale", title = "b.) Unweighted Likelihood of Response by Scale Only") +
  annotate("text", x = 1:5, y = 13, label = c("MARGINAL", "SLIGHT", "ENHANCED", "MODERATE", "HIGH"), size = 5, color = colors[1]) +
  annotate("text", x = 1:5, y = 10, label = c("VERY LOW", "LOW", "MEDIUM", "HIGH", "VERY HIGH"), size = 5, color = colors[2]) +
  annotate("text", x = 1:5, y = 7, label = c("MINIMAL", "LOW", "MODERATE", "HIGH", "EXTREME"), size = 5, color = colors[3]) +
  annotate("text", x = 1:5, y = 4, label = c("LEVEL 1 OF 5", "LEVEL 2 OF 5", "LEVEL 3 OF 5", "LEVEL 4 OF 5", "LEVEL 5 OF 5"), size = 5, color = colors[4]) +
...
Scale_eff_means <- SPCdata %>% 
  ...
  summarise(mean = mean(value, na.rm = TRUE), 
            ...
            n = n()) %>% 
  mutate(se = sd / sqrt(n))
c = ggplot(Scale_eff_means, aes(x = Level, y = mean, color = Version, Level = Version, shape = Version)) +
  geom_line(linewidth = 1.2, position = position_dodge(width = 0.35)) +
  geom_point(size = 3.5, position = position_dodge(width = 0.35)) +
  geom_errorbar(size = 1.2, aes(ymin = mean - (1.645 * se), ymax = mean + (1.645 * se)), width = 0.3, position = position_dodge(width = 0.35)) +
  scale_shape_manual(name = "Scale", values = c(15, 16, 17, 18), limits = c("current_scale","likert_scale","spanish_scale","levels_scale"), 
  ...
  scale_color_manual(limits = c("current_scale","likert_scale","spanish_scale","levels_scale"), 
                     labels=c('Current\nScale', 'Likert\nScale', '"Spanish"\nScale', 'Numbered\nScale'), values = colors) +
  labs(y = "Mean Percieved Response Efficacy", x = "", color = "Scale", title = "c.) Unweighted Percieved Response Efficacy by Scale Only") +
  annotate("text", x = 1:5, y = 13, label = c("MARGINAL", "SLIGHT", "ENHANCED", "MODERATE", "HIGH"), size = 5, color = colors[1]) +
  annotate("text", x = 1:5, y = 10, label = c("VERY LOW", "LOW", "MEDIUM", "HIGH", "VERY HIGH"), size = 5, color = colors[2]) +
  annotate("text", x = 1:5, y = 7, label = c("MINIMAL", "LOW", "MODERATE", "HIGH", "EXTREME"), size = 5, color = colors[3]) +
  annotate("text", x = 1:5, y = 4, label = c("LEVEL 1 OF 5", "LEVEL 2 OF 5", "LEVEL 3 OF 5", "LEVEL 4 OF 5", "LEVEL 5 OF 5"), size = 5, color = colors[4]) +
...
g <- arrangeGrob(a, b, c, nrow = 2)
#ggsave(filename = "Conc_Resp_Eff_UW.png", height = 20, width = 25, path = "Directory of Choice", g)
...
Scale_con_map_means <- SPCdata %>% 
  ...
  summarise(mean = mean(value, na.rm = TRUE), 
            ...
            n = n()) %>% 
  mutate(se = sd / sqrt(n))
a = ggplot(Scale_con_map_means, aes(x = Level, y = mean, color = Version, Level = Version, shape = Version)) +
  geom_line(linewidth = 1.2, position = position_dodge(width = 0.35)) +
  geom_point(size = 3.5, position = position_dodge(width = 0.35)) +
  geom_errorbar(size = 1.2, aes(ymin = mean - (1.645 * se), ymax = mean + (1.645 * se)), width = 0.3, position = position_dodge(width = 0.35)) +
  scale_shape_manual(name = "Scale", values = c(15, 16, 17, 18), limits = c("current_scale","likert_scale","spanish_scale","levels_scale"), 
  ...
  scale_color_manual(limits = c("current_scale","likert_scale","spanish_scale","levels_scale"), 
                     labels=c('Current\nScale', 'Likert\nScale', '"Spanish"\nScale', 'Numbered\nScale'), values = colors) +
  labs(y = "Mean Concern", x = "", color = "Scale", title = "a.) Unweighted Concern with Map and Words") +
  annotate("text", x = 1:5, y = 13, label = c("MARGINAL", "SLIGHT", "ENHANCED", "MODERATE", "HIGH"), size = 5, color = colors[1]) +
  annotate("text", x = 1:5, y = 10, label = c("VERY LOW", "LOW", "MEDIUM", "HIGH", "VERY HIGH"), size = 5, color = colors[2]) +
  annotate("text", x = 1:5, y = 7, label = c("MINIMAL", "LOW", "MODERATE", "HIGH", "EXTREME"), size = 5, color = colors[3]) +
  annotate("text", x = 1:5, y = 4, label = c("LEVEL 1 OF 5", "LEVEL 2 OF 5", "LEVEL 3 OF 5", "LEVEL 4 OF 5", "LEVEL 5 OF 5"), size = 5, color = colors[4]) +
...
Scale_resp_map_means <- SPCdata %>% 
  ...
  summarise(mean = mean(value, na.rm = TRUE), 
            ...
            n = n()) %>% 
  mutate(se = sd / sqrt(n))
b = ggplot(Scale_resp_map_means, aes(x = Level, y = mean, color = Version, Level = Version, shape = Version)) +
  geom_line(linewidth = 1.2, position = position_dodge(width = 0.35)) +
  geom_point(size = 3.5, position = position_dodge(width = 0.35)) +
  geom_errorbar(size = 1.2, aes(ymin = mean - (1.645 * se), ymax = mean + (1.645 * se)), width = 0.3, position = position_dodge(width = 0.35)) +
  scale_shape_manual(name = "Scale", values = c(15, 16, 17, 18), limits = c("current_scale","likert_scale","spanish_scale","levels_scale"), 
  ...
  scale_color_manual(limits = c("current_scale","likert_scale","spanish_scale","levels_scale"), 
                     labels=c('Current\nScale', 'Likert\nScale', '"Spanish"\nScale', 'Numbered\nScale'), values = colors) +
  labs(y = "Mean Likelihood of Response", x = "", color = "Scale", title = "b.) Unweighted Likelihood of Response with Map and Words") +
  annotate("text", x = 1:5, y = 13, label = c("MARGINAL", "SLIGHT", "ENHANCED", "MODERATE", "HIGH"), size = 5, color = colors[1]) +
  annotate("text", x = 1:5, y = 10, label = c("VERY LOW", "LOW", "MEDIUM", "HIGH", "VERY HIGH"), size = 5, color = colors[2]) +
  annotate("text", x = 1:5, y = 7, label = c("MINIMAL", "LOW", "MODERATE", "HIGH", "EXTREME"), size = 5, color = colors[3]) +
  annotate("text", x = 1:5, y = 4, label = c("LEVEL 1 OF 5", "LEVEL 2 OF 5", "LEVEL 3 OF 5", "LEVEL 4 OF 5", "LEVEL 5 OF 5"), size = 5, color = colors[4]) +
...
Scale_eff_map_means <- SPCdata %>% 
  ...
  summarise(mean = mean(value, na.rm = TRUE), 
            ...
            n = n()) %>% 
  mutate(se = sd / sqrt(n))
c = ggplot(Scale_eff_map_means, aes(x = Level, y = mean, color = Version, Level = Version, shape = Version)) +
  geom_line(linewidth = 1.2, position = position_dodge(width = 0.35)) +
  geom_point(size = 3.5, position = position_dodge(width = 0.35)) +
  geom_errorbar(size = 1.2, aes(ymin = mean - (1.645 * se), ymax = mean + (1.645 * se)), width = 0.3, position = position_dodge(width = 0.35)) +
  scale_shape_manual(name = "Scale", values = c(15, 16, 17, 18), limits = c("current_scale","likert_scale","spanish_scale","levels_scale"), 
  ...
  scale_color_manual(limits = c("current_scale","likert_scale",'spanish_scale',"levels_scale"), 
                     labels=c('Current\nScale', 'Likert\nScale', '"Spanish"\nScale', 'Numbered\nScale'), values = colors) +
  labs(y = "Mean Efficacy of Response", x = "", color = "Scale", title = "c.) Unweighted Percieved Response Efficacy with Map and Words") +
  annotate("text", x = 1:5, y = 13, label = c("MARGINAL", "SLIGHT", "ENHANCED", "MODERATE", "HIGH"), size = 5, color = colors[1]) +
  annotate("text", x = 1:5, y = 10, label = c("VERY LOW", "LOW", "MEDIUM", "HIGH", "VERY HIGH"), size = 5, color = colors[2]) +
  annotate("text", x = 1:5, y = 7, label = c("MINIMAL", "LOW", "MODERATE", "HIGH", "EXTREME"), size = 5, color = colors[3]) +
  annotate("text", x = 1:5, y = 4, label = c("LEVEL 1 OF 5", "LEVEL 2 OF 5", "LEVEL 3 OF 5", "LEVEL 4 OF 5", "LEVEL 5 OF 5"), size = 5, color = colors[4]) +
...
g <- arrangeGrob(a, b, c, nrow = 2)
#ggsave(filename = "Conc_Resp_Eff_MAP_UW.png", height = 20, width = 25, path = "Directory of Choice", g)
